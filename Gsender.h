...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "c2luZ2hyYXRuZXNoMDY1QGdtYWlsLmNvbQ0K";
        const char* EMAILBASE64_PASSWORD = "UmFqYW5SYXQ5OCM=";
        const char* FROM = "singhratnesh065@gmail.com";
